# 🔬 Mathematical Modeling & Statistical Features

## Overview

AutoFE-X now includes **mathematical modeling** and **statistical transformation** capabilities that leverage numpy, pandas, scipy, and scikit-learn to their fullest potential.
...
The `StatisticalTransforms` provides comprehensive statistical transformations:
...
```python
from autofex import StatisticalTransforms
...
## 🎯 Integration with AutoFE-X

### Combined Usage

```python
from autofex import AutoFEX, MathematicalModelingEngine, StatisticalTransforms

# Run AutoFE-X pipeline
...
5. **Integrated**: Works seamlessly with AutoFE-X pipeline
