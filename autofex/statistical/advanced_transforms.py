...
Leverages scipy.stats and numpy for advanced statistical feature engineering.
"""
...
from scipy.special import boxcox, yeojohnson, logit, expit
import warnings


class AdvancedStatisticalTransforms:
    """
    Advanced statistical transformations using scipy and numpy.
    """

    def __init__(self, config: Optional[Dict[str, Any]] = None):
        """
        Initialize advanced statistical transforms.
    ...
    def yeojohnson_transform(
        ...
        try:
            if lmbda is None:
                transformed, lmbda_opt = stats.yeojohnson(series_clean)
            else:
                transformed = yeojohnson(series_clean, lmbda)
                lmbda_opt = lmbda
